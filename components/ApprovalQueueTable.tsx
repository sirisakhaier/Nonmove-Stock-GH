          ...
          <table className="w-full text-left text-xs text-slate-600 dark:text-slate-300">
            <thead className="bg-slate-50 dark:bg-slate-800/60 text-[11px] uppercase tracking-wider text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-800">
              <tr>
                ...
                <th className="py-3.5 px-4 font-semibold">เหตุผล / รายละเอียด</th>
                ...
                filteredRequests.map((r) => (
                  <tr key={r.id} className="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors">
                    <td className="py-3.5 px-4 whitespace-nowrap">
                      ...
                      <div className="text-[10px] text-blue-600 dark:text-blue-400 font-semibold">{r.store?.region || "OTHER"}</div>
                    </td>
                    ...
                    <td className="py-3.5 px-4 max-w-sm">
                      ...
                      {r.comments && (
                        <div className="text-slate-600 dark:text-slate-400 text-[11px] mt-0.5 line-clamp-2">
                          {r.comments}
                        </div>
                      )}
                        ...
                        <div className="flex items-center justify-center gap-1">
                          {r.photos.map((p) => (
                            <button
                              ...
                              className="relative h-9 w-9 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700 hover:opacity-80 transition-opacity"
                            >
                    ...
                    <td className="py-3.5 px-4 text-center whitespace-nowrap">
                      ...
                      {r.reviewComment && (
                        <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-1 max-w-[150px] truncate mx-auto">
                      ...
                      {r.status === "PENDING" ? (
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 rounded-xl bg-rose-600 px-3 py-1.5 text-xs font-bold text-white shadow-sm hover:bg-rose-700 transition-colors"
                          >
                        ...
                        <span className="text-[11px] text-slate-400 dark:text-slate-500">ดำเนินการแล้ว</span>
                      )}
                    </td>
                  </tr>
                ))
          ...
          <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-4">
            <div className="flex items-center gap-2.5">
              <div className={`p-2 rounded-xl ${
                activeModal.decision === "APPROVED" ? "bg-emerald-100 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400" : "bg-rose-100 dark:bg-rose-950/60 text-rose-600 dark:text-rose-400"
              }`}>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 p-2.5 text-xs text-slate-900 dark:text-white shadow-sm focus:border-blue-500 focus:outline-none"
              />
            </div>
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-slate-200 dark:border-slate-800">
              <button
                ...
                className="rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700"
              >
                ยกเลิก
              </button>
              <button
